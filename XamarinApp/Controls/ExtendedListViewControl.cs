...
namespace XamarinApp.Controls
{
    ...
    {
        public ExtendedListViewControl() : this(ListViewCachingStrategy.RecycleElement)
        {
        }

        public ExtendedListViewControl(ListViewCachingStrategy cachingStrategy) : base(cachingStrategy)
        {
        ...
        public static readonly BindableProperty TappedCommandProperty =
            BindableProperty.Create(nameof(TappedCommand), typeof(ICommand), typeof(ExtendedListViewControl), default(ICommand));
        ...
        public static readonly BindableProperty ItemAppearingCommandProperty =
            BindableProperty.Create(nameof(ItemAppearingCommand), typeof(ICommand), typeof(ExtendedListViewControl), default(ICommand));
        ...
        public static readonly BindableProperty ItemDisappearingCommandProperty =
         BindableProperty.Create(nameof(ItemDisappearingCommand), typeof(ICommand), typeof(ExtendedListViewControl), default(ICommand));
        ...
        {
            var listView = (ExtendedListViewControl)sender;
            if (e == null) return;
